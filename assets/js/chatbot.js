...
function simplifyMessage(message) {
  ...
  .replace(/how r u|how are u/g, "how are you")
  ...
  .replace(/think u r|think ur /g, "think you are")
  .replace(/do u think/g, "do you think")
  .replace(/youre|ur /g, "you are")
  .replace(/bare with me/g, "bear with me")
  .replace(/love u|love you|loveyou/g, "i love you")
  .replace(/thank u|thankyou/g, "thank you")
  .replace(/thx|tks|tnx/g, "thanks")
  .replace(/sry|srry/g, "sorry")
  .replace(/brb/g, "be right back")
  .replace(/give me a sec|give me a min/g, "give me a moment")
  .replace(/hold on a sec|hold on a min/g, "hold on a moment")
  .replace(/hang on a sec|hang on a min/g, "hang on a moment")
  .replace(/just a sec|just a min/g, "just a moment")
  .replace(/wait a sec|wait a min/g, "wait a moment")
  .replace(/app /g, "application ")
  .replace(/has been|was/g, "is")
  .replace(/ has /g, " ")
  ...
  .replace(/ beyond /g, " ")
  .replace(/ being /g, " ")
  .replace(/ please |please| pls |pls/g, " ")
  .replace(/ for /g, " ");
}
